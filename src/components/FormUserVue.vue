  ...
  <div class="milieu_f_u">
    <div class="formulaire_display">
      ...
      <form class="formulaire">
        ...
        <div
          class="champ"
          v-bind:id="selectionne"
          v-if="selectionne === 'gestionnaire'"
        >
        ...
        <div class="envoi">
          <button
            ...
            type="submit"
            @click="
              verifier_form('Le formulaire n\'a pas pu être envoyé', $event)
            "
          >
    ...
    verifier_form: function (message_erreur, event) {
      ...
      if (select.value == "gestionnaire") {
        ...
        if (ecartvalide) {
          ...
          message.textContent = "La date de désactivation doit être postérieure à la date d'activation."
          console.log("message_erreur")
          if (typeof event.cancelable !== "boolean" || event.cancelable) {
            event.preventDefault()
          }
